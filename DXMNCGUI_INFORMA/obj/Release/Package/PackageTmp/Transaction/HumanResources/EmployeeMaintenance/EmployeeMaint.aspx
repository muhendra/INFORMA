<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="EmployeeMaint.aspx.cs" Inherits="DXMNCGUI_INFORMA.Transaction.HumanResources.EmployeeMaintenance.EmployeeMaint" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxFormLayout runat="server" ID="FormLayout" ClientInstanceName="FormLayout" Font-Names="Calibri">
        ...
        <Items>
            <dx:LayoutGroup ShowCaption="True" GroupBoxDecoration="HeadingLine" Caption="Employee Maintenance" ColCount="5">
                <GroupBoxStyle>
