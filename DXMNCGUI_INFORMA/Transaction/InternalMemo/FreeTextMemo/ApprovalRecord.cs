...
namespace DXMNCGUI_INFORMA.Transaction.InternalMemo.FreeTextMemo
{
    public class ApprovalRecord
    {
        ...
        private FreeTextMemoEntity myFreeTextMemo;
        ...
        internal ApprovalRecord(DataRow row, FreeTextMemoEntity FreeTextMemoEntity)
        {
            this.myRow = row;
            this.myFreeTextMemo = FreeTextMemoEntity;
        }
    }
}