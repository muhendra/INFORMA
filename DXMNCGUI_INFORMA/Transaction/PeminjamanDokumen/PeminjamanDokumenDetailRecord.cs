...
{
    public class PeminjamanDokumenDetailRecord
    {
        private DataRow myRow;
        private PeminjamanDokumenEntity myPeminjamanDokumen;
        ...
        internal PeminjamanDokumenDetailRecord(DataRow row, PeminjamanDokumenEntity PeminjamanDokumenEntity)
        {
            this.myRow = row;
            this.myPeminjamanDokumen = PeminjamanDokumenEntity;
        }
    }
}